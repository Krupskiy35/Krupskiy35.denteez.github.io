...
var headerCarousel = new Carousel('.header-carousel', {
    withPager: true
});
...
var myTasks = new TaskList('.my-task-list');
...
var Tabs = function () {
    function Tabs(cssSelector) {
        _classCallCheck(this, Tabs);

        this.tabsRoot = $(cssSelector);
        this.controls = this.tabsRoot.find('.tabs__control').get();
        this.contents = this.tabsRoot.find('.tabs__content').get();
        this.handleEvents();
    }
    ...
    _createClass(Tabs, [{
        ...
        value: function switchOff() {
            ...
            this.controls.forEach(function (item, i) {
                ...
                $(_this.contents[i]).removeClass('active');
            });
        }
    }, {
        key: 'toggleContent',
        value: function toggleContent(dataControlId) {
            var targetContentEl = this.contents.filter(function (item) {
                return $(item).attr('data-content-id') === dataControlId;
            })[0];

            $(targetContentEl).addClass('active');
        }
    }, {
        key: 'clickHandler',
        value: function clickHandler(jqEl) {
            var dataControlId = jqEl.attr('data-control-id');

            this.switchOff();
            jqEl.addClass('active');

            this.toggleContent(dataControlId);
        }
    }, {
        key: 'handleEvents',
